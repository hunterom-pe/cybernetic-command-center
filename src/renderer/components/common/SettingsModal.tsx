...
const ALL_WIDGET_ROSTER: { id: string; name: string }[] = [
  ...
  { id: 'ship_wireframe', name: 'USCSS Starfreighter 3D Wireframe' },
  { id: 'solar_orbital', name: 'Solar System & Colony Orbital Map' },
  { id: 'holo_gyro', name: '3D Holographic Gyroscope' },
  { id: 'tesseract', name: '4D Hypercube Tesseract Engine' },
  { id: 'particle_swarm', name: 'Sub-Space Particle Swarm' },
  { id: 'terrain_radar', name: '3D Topographic Heightmap Radar' },
